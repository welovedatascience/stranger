...
#' --> \code{\link{get_strangest}} (flag top \emph{n.anom} anomalies) --> \code{\link{fortify}} to enrich source data.
...
#' @param stack Stacking metric passed to \code{\link{gest_strangest}}.
#' @param stack.method Stacking selection method passed to  \code{\link{gest_strangest}}.
#'
